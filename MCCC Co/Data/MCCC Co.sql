...
VALUES
  ...
  ('Entrepôt de Cymbales','403-6177 Elementum St.','','Saint-Dizier','Champagne-Ardenne','France','38145','04 39 63 73 26'),
  ...
  ('Werner Schlagzeug','189 Magnis Street','','Aalen','Baden Württemberg','Germany','42455','(05334) 1031274'),
  ('Beckenhaus','2076 Cursus. Ave','','Bremerhaven','Bremen','Germany','30855','(08881) 9638223'),
  ('Trommelversorgung','2440 In Road','','Friedrichshafen','Baden Württemberg','Germany','96414','(0388) 16401169'),
  ('Schlagzeugerland','9544 Ac, Street','','Mülheim','Nordrhein-Westphalen','Germany','24632','(02713) 8142032')
GO